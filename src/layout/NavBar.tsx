                ...
                <div className="font-[Manrope] sm:p-4 py-2 px-4 flex flex-row items-center justify-between border border-[#5E5B5B] bg-black rounded-2xl w-full">
                    ...
                    <div className="xl:flex gap-6 hidden">
                        ...
                        <button
                            ...
                            className="text-black bg-gradient-to-r from-[#E60283] via-[#F1D507] to-[#DA4A02] rounded-xl font-semibold px-8 py-3 text-sm"
                        >
                            Get A Quote
                        </button>
                    </div>
                    ...
                    <div className="lg:hidden flex flex-row gap-2 items-center">
                        <button
                            onClick={() => setGetAQuoteModelOpen(true)}
                            className="flex text-black bg-gradient-to-r from-[#E60283] via-[#F1D507] to-[#DA4A02] rounded-md font-semibold px-4 py-2 text-xs"
                        >
                            Get A Quote
                        </button>
